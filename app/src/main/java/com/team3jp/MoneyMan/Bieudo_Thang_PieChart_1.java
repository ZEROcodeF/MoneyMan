...
public class Bieudo_Thang_PieChart_1 extends Fragment implements OnChartValueSelectedListener {
    ...
    public static Bieudo_Thang_PieChart_1 newInstance() {
        Bieudo_Thang_PieChart_1 fragment = new Bieudo_Thang_PieChart_1();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RelativeLayout relativeLayout = (RelativeLayout) inflater.inflate(R.layout.bieudo_thang_piechart_1, null);

        tvThangnay = (TextView) relativeLayout.findViewById(R.id.tvthang_1);
        ...
        tvThangnay.setText("Tháng " + currentDate.substring(5) + " này");
...
//        }
        ...
        mChart = (PieChart) relativeLayout.findViewById(R.id.piechart_thang_1);
    ...
    public void onValueSelected(Entry e, Highlight h) {
        ...
        String tmp = null;
        if (h.getX() == 0) tmp = "Tổng thu nhập tháng này: ";
        else tmp = "Tổng chi phí tháng này: ";
