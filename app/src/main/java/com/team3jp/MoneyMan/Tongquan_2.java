...
public class Tongquan_2 extends Fragment implements OnChartValueSelectedListener {
    PieChart mChart;
    ...
    public static Tongquan_2 newInstance() {
        Tongquan_2 fragment = new Tongquan_2();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CardView cardView = (CardView) inflater.inflate(R.layout.tongquan_2, null);
...
//        }
        ...
        mChart = (PieChart) cardView.findViewById(R.id.piechart_tongquan_1);
    ...
    public void onValueSelected(Entry e, Highlight h) {
        ...
        String tmp = null;
        if (h.getX() == 0) tmp = "Tổng thu nhập hôm nay: ";
        else tmp = "Tổng chi phí hôm nay: ";
    ...
    private boolean check(String datetime) {
        boolean flag = true;
        ...
        return datetime.startsWith(currentDate);
